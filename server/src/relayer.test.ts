...
describe("relayer — sponsored-selector allowlist", () => {
  ...
  it("never sponsors owner/host functions (createMatch, settle, lockBetting, openVotedOutRound, closeProp)", () => {
    for (const fn of ["createMatch", "settle", "lockBetting", "openVotedOutRound", "closeProp"]) {
